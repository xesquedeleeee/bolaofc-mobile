...
export default function PerfilLevi() {
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.name, { color: colors.text }]}>Levi Vitor</Text>
      ...
      >
        ...
        <View style={[styles.infoRow, { borderBottomColor: colors.border }]}>
          ...
          <Text style={[styles.infoValue, { color: colors.text }]}>855503</Text>
        </View>
        <View style={[styles.infoRow, { borderBottomColor: colors.border }]}>
          <Text style={[styles.infoLabel, { color: colors.textMuted }]}>
            Curso
      ...
      >
        ...
        <Text style={[styles.cardText, { color: colors.textMuted }]}>
          ...
          ranking geral de usuários no backend, e telas de palpites e ranking no
          mobile.
        </Text>
      </View>
